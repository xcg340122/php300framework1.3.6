...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var string[]
     */
    private static $obsoleteProperties = ['resource_caching', 'template_resource_caching',
     ...
     * @var array
     */
    private static $accessMap = ['template_dir'      => 'TemplateDir', 'config_dir' => 'ConfigDir',
    ...
    public function addTemplateDir($template_dir, $key = null, $isConfig = false)
    {
        ...
        $this->{$joined} .= ' # '.implode(' # ', (array) $template_dir);
