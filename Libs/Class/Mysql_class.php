...
class Mysql_class
{
    ...
    private $Handle = ['join', 'where', 'field', 'union', 'group', 'order', 'limit', 'page', 'alias'];

    private $Symbol = ['eq'     => '=', 'neq'    => '<>', 'gt'     => '>', 'lt'     => '<', 'elt'    => '<=', 'egt'    => '>=', 'like'   => 'LIKE', 'in'     => 'IN', 'between'=> 'BETWEEN', 'notnull'=> 'IS NUT NULL', 'null'   => 'IS NULL'];
     ...
     * @param sql语句 $sql
     */
    public function query($sql, $isReS = false)
    {
    ...
    */
    ...
    public function select()
    {
        ...
        return (is_array($DataList)) ? ($DataList) : ([]);
    }
    ...
    public function where($where = '')
    {
        if (is_array($where)) {
            foreach ($where as $key => $val) {
                ...
                $Symbols = (in_array($Symbol, ['IN', 'BETWEEN'])) ? ('') : ("'");
